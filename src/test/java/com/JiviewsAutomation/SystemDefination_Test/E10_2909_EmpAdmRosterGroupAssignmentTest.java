...
public class E10_2909_EmpAdmRosterGroupAssignmentTest extends BaseClass{
	...
	private static final Logger logger = Logger.getLogger(E10_2909_EmpAdmRosterGroupAssignmentTest.class.getName());
...
//		
//		rosterGrpAssignment.AddEmployeesNonMembersToMembersAndRemoveFromMembersToNonMember(fakeEmployee);
