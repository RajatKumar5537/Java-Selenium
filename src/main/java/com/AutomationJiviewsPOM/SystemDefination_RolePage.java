...
public class SystemDefination_RolePage 
{
	...
	@FindBy(xpath = "//div[text()='Selected Role Data Deleted Successfully']")
	WebElement roleDeletedSuccessfullyMsg;
	...
	public void createNewRole() throws Exception 
	{
		...
		Rc.moveToElement(selectPrimarySkillId);
		selectPrimarySkillId.click();
		Rc.moveToElement(selectSkillCode);
	...
	public void deleteRole() throws InterruptedException 
	{
		...
		clickYes.click();
		String actualResult = roleDeletedSuccessfullyMsg.getText();
		Assert.assertTrue(actualResult.contains("Selected Role Data Deleted Successfully"));
		Rc.explicitWait(notificationPopup, "clickable");
		notificationPopup.click();
	}
	...
	public void setCreateNewRoleWithoutRoleCode() throws Exception 
	{
		...
		Rc.moveToElement(selectPrimarySkillId);
		selectPrimarySkillId.click();
		Rc.scrollToElement(selectSkillCode);
		selectSkillCode.click();
		roleWaightage.clear();
		roleWaightage.sendKeys(Rc.randomInt);
		Rc.scrollToElement(availableSkill);
