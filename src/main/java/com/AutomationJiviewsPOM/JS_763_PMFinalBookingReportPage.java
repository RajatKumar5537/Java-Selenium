...
public class JS_763_PMFinalBookingReportPage {
	...
	@FindBy(xpath = "//li[@data-menu-link='Operations/FinalBookingReport/PMFinalBookingReport']")
	WebElement PMFinalBookingReport;

	@FindBy(xpath = "//input[@id='dtOperation']")
	WebElement dtOperation;
	...
	WebElement selectShiftbandResult ;
	...
	@FindBy(xpath = "//span[@id='select2-cmbEmployeeNumber-container']")
	...
	@FindBy(xpath = "//label[@class='custom-control custom-checkbox m-0']/span[text()='Deployed Rank Discrepancy']")
	WebElement DeployedRankDiscrepancy ;
...
//	Deployment ................. 
	...
	@FindBy(xpath = "//ul[@class='select2-results__options']/li[text()='PM Deployment - PM Deployment']")
...
//		E10_3562_Create Or Assign Task .........................
		...
		WebElement empNumber; // we can compare the Emp no from the table and compare with create table 
	...
	public JS_763_PMFinalBookingReportPage(WebDriver driver) {
...
//		this.action= new Actions(driver);
	...
	public void E10_SearchPMFinalBookingReport() throws InterruptedException {
		
		PMFinalBookingReport.click();
		
		
		Thread.sleep(5000);
		dtOperation.clear();
		dtOperation.sendKeys("10/03/2024");
		dtOperation.sendKeys(Keys.ENTER);
		
		Thread.sleep(3000);
		cmbShiftBand.click();
		selectShiftbandResult.click();
		
		selectLocation.isDisplayed();
		rank.isDisplayed();
		skillName.isDisplayed();
		equipmentName.isDisplayed();
		employeeNumber.isDisplayed();
		
		btnSearch.click();
	}
	
	public void E10_SearchByShowStandbyEmployees() throws InterruptedException{
	...
	public void E10_SearchByNonPrimarySkillDeployedEmployee() throws InterruptedException{
	...
	public void E10_SearchByUnallocatedWork() throws InterruptedException {
	...
	public void E10_SearchByOnCallList() throws InterruptedException {
	...
	public void E10_Deployment() throws InterruptedException {
		Thread.sleep(5000);
		clickBtnDeployment();
		clickBtnDeploy();
		Thread.sleep(2000);
	...
	public void JS_RevokeSignOff() throws InterruptedException {
	...
	public void JS_BroadcastDeployment() throws InterruptedException {
		Thread.sleep(5000);
		clickBtnDeployment();
	...
	public void E10_SwapEmployeeAllocation() throws InterruptedException {
		Thread.sleep(5000);
		clickBtnExecution();
	...
	public void E10_AddEquipments() throws InterruptedException{
		Thread.sleep(5000);
		clickBtnExecution();
	...
	public void E10_AddWorkload() throws Exception {
		Thread.sleep(5000);
		clickBtnExecution();
	...
	public void E10_SwapEmployeeShift() throws InterruptedException {
		Thread.sleep(5000);
		clickBtnExecution();
	...
	public void E10_CreateOrAssignTask() throws InterruptedException{
